...
<div>
  ...
  <div v-for="exercise in searchResults" class="flex flex-row mt-5">
    <div class="basis-1/2">
      <img :src="`/exercises/${exercise.images[0]}`" style="width: 100px" />
    </div>
    <div class="basis-1/2" style="color:white">
      {{ exercise.name }}
    </div>
  </div>
</div>
